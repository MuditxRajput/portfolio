            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>muditrajputpersonal@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Mudit Rajput</span>
                    </div>
                    <div className="max-w-[510px]">
                    I am looking for a company which has a great learning curve, next level working experience, and most important supporting team and leader which help me to grow more in my growth as well as in company growth.
                    </div>
                </motion.div>
                {/* INTRO END */}
